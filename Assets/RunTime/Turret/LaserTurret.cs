...
public class LaserTurret : MonoBehaviour
{
    ...
    {
        // 블릿 오브젝트 풀 수정 필요
        GameObject LaserGo = BulletObjectPool._instance.SpawnBullet(_firePoint.position, _firePoint.rotation);
        ...
        Bullet Lsser = LaserGo.GetComponent<Bullet>();

        if (Lsser != null)
        {
            // 블릿 오브젝트 풀 수정 필요
            Lsser.Seek(_target, BulletImpactObjectPool._instance);
        }
    }
